...
export const PersonalInfoForm: React.FC<PersonalInfoFormProps> = ({ data, onChange }) => {
  ...
  return (
    <div className="space-y-4 border border-foreground p-6 bg-card shadow-sw-sm">
      <h3 className="font-serif text-xl font-bold border-b border-foreground pb-2 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="rounded-none border-foreground focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-blue-700 bg-transparent"
          />
        </div>
        <div className="space-y-2">
          <Label
