    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] p-0 gap-0 rounded-none overflow-hidden">
        ...
        <div className="px-6 pt-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-green-50 dark:bg-green-950 border border-green-200 text-green-700 font-mono text-xs">
        ...
        {regenerateErrors.length > 0 ? (
          <div className="px-6 pt-4">
            <div className="border border-foreground bg-[#FFF9DB] px-4 py-3">
              ...
              <ul className="mt-2 space-y-1">
                {regenerateErrors.map((failed) => (
                  <li key={failed.item_id} className="font-mono text-xs text-foreground">
                    • {getItemLabel(failed)}
                  </li>
                ))}
              </ul>
        ...
        <div className="p-6 space-y-4 max-h-[50vh] overflow-y-auto">
          {regeneratedItems.map((item) => (
            <div key={item.item_id} className="border border-foreground">
              {/* Item Header */}
              <button
                type="button"
                ...
                <div className="border-t border-foreground">
                  ...
                  <div className="p-4 border-b border-foreground">
                    <div className="font-mono text-xs uppercase tracking-wider text-muted-foreground mb-2 flex items-center gap-2">
                      <span className="w-3 h-3 bg-red-600 border border-foreground" />
                  ...
                  <div className="p-4">
                    <div className="font-mono text-xs uppercase tracking-wider text-muted-foreground mb-2 flex items-center gap-2">
                      <span className="w-3 h-3 bg-green-700 border border-foreground" />
