    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex flex-col items-center justify-center p-8 bg-background">
          <div className="max-w-md w-full bg-card border border-foreground shadow-sw-default p-8">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <div className="mb-4 p-3 bg-red-50 dark:bg-red-950 border border-red-200 rounded-none">
            ...
            <div className="flex gap-3">
              <Button
                ...
                variant="outline"
                className="flex-1 border-foreground rounded-none shadow-sw-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all"
              >
                {strings.tryAgain}
              </Button>
              <Button
                onClick={this.handleReload}
                className="flex-1 bg-blue-700 hover:bg-blue-800 text-white rounded-none border border-foreground shadow-sw-sm hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-none transition-all"
              >
