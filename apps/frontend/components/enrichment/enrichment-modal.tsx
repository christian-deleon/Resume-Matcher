  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center p-5 sm:p-10">
        <div className="relative w-full h-full max-w-[1200px] bg-card border-2 border-foreground shadow-sw-lg-solid flex flex-col overflow-hidden">
          {/* Header */}
          <div className="flex items-center justify-between px-6 py-4 border-b-2 border-foreground bg-accent">
